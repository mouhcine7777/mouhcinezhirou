...
const data = getCityPage("developpeur-web-freelance-rabat")!;
const PAGE_PATH = `/${data.slug}`;

export const metadata: Metadata = {
  title: `Développeur Web Freelance à ${data.city}`,
  description: `Développeur web freelance pour Rabat, spécialisé React et Next.js. Sites institutionnels, vitrines et sur mesure, devis clair sous 24h, travail 100% à distance.`,
  keywords: data.metaKeywords,
  alternates: { canonical: `${SITE}${PAGE_PATH}` },
  openGraph: {
    title: `Développeur Web Freelance à ${data.city} | Mouhcine Zhirou`,
    description: `Un seul interlocuteur, devis clair sous 24h. Développeur web freelance pour Rabat, spécialisé React et Next.js.`,
    url: `${SITE}${PAGE_PATH}`,
    locale: "fr_MA",
    type: "website",
  },
