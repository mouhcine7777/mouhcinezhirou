...
const projects = [
  ...
  { id: 2,  title: "Public Events Website",        description: "Une plateforme moderne pour découvrir et gérer des événements publics avec une expérience utilisateur fluide.",                             tags: ["Événements", "Web App"],    url: "https://newpe-5j8u.vercel.app/",          image: "/projects/pe-portfolio.jpeg" },
  { id: 3,  title: "Adventure Road",               description: "Club Polaris Buggies à Marrakech — aventures tout-terrain palpitantes à travers le désert et les montagnes.",                              tags: ["Aventure", "Marrakech"],    url: "https://www.adventure-road.ma/",          image: "/projects/adventure-road-portfolio.jpeg" },
  ...
  { id: 6,  title: "Palooza Park",                 description: "Site web de parc de loisirs avec des fonctionnalités interactives et un système de réservation pour le plaisir en famille.",              tags: ["Loisirs", "Famille"],       url: "https://www.paloozaland.com",             image: "/projects/palooza-portfolio.jpeg" },
  { id: 7,  title: "Oxygen Village",               description: "Un hôtel en containers unique niché à Midelt — nature, architecture et tranquillité réunies.",                                            tags: ["Hôtel", "Éco", "Midelt"],   url: "https://oxygen-village.ma/",              image: "/projects/oxygen-portfolio.jpeg" },
  { id: 8,  title: "Garden Corner",                description: "Un univers pensé pour vivre, partager et profiter pleinement — une destination lifestyle.",                                               tags: ["Lifestyle", "Hospitalité"], url: "https://gardencorner.vercel.app/",        image: "/projects/gardencorner-portfolio.jpeg" },
