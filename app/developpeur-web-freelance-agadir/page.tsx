...
const data = getCityPage("developpeur-web-freelance-agadir")!;
const PAGE_PATH = `/${data.slug}`;

export const metadata: Metadata = {
  title: `Développeur Web Freelance à ${data.city}`,
  description: `Développeur web freelance pour Agadir, spécialisé React et Next.js. Sites tourisme, export et e-commerce sur mesure, devis clair sous 24h, travail à distance.`,
  keywords: data.metaKeywords,
  alternates: { canonical: `${SITE}${PAGE_PATH}` },
  openGraph: {
    title: `Développeur Web Freelance à ${data.city} | Mouhcine Zhirou`,
    description: `Un seul interlocuteur, devis clair sous 24h. Développeur web freelance pour Agadir, spécialisé React et Next.js.`,
    url: `${SITE}${PAGE_PATH}`,
    locale: "fr_MA",
    type: "website",
  },
